...
<template>
  <div class="bg-black/5 dark:bg-white/10 my-3 mr-3 p-3 rounded-3xl flex flex-col m-3 p-3">
    ...
    <form @submit.prevent="handlePlaceOrder" class="flex flex-col flex-grow min-h-0">
      ...
      <div class="mt-auto pt-4">
        <div class="text-sm font-semibold p-4 text-neutral-600 dark:text-neutral-400">
          Paying a total of ${{ cartTotal }} for {{ cart.length }} products.
        </div>
        ...
        <button
          ...
          <Transition name="slide-up">
            <div v-if="!isLoading" class="absolute">Pay ${{ cartTotal }}</div>
