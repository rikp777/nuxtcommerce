  ...
  <div v-if="shouldRender" class="flex flex-col gap-4">
    ...
    <div class="flex gap-3">
      <a
          ...
          class="flex items-center justify-center w-10 h-10 rounded-full bg-white dark:bg-white/10 text-neutral-600 dark:text-neutral-400 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-all duration-300 active:scale-95"
      >
